...
function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-600 backdrop-filter backdrop-blur-md bg-opacity-5 dark:backdrop-filter dark:backdrop-blur-lg dark:bg-opacity-5">
