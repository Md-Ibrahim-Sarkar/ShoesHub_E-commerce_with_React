      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
          <div className="flex items-center">
            ...
            <a href="#" className="text-sm font-medium text-gray-700 ms-1 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">My account</a>
          </div>
        </li>
      ...
      <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
        <div className="space-y-4">
          <div className="flex space-x-4">
            <img referrerPolicy='no-referrer' className="w-16 h-16 rounded-lg" src={ user?.photoURL} alt="Helene avatar" />
            <div>
              <span className="mb-2 inline-block rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> PRO Account </span>
                                  <h2 className="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">{user?.displayName}</h2>
            </div>
          </div>
          <dl className="">
    ...
    <div className="relative w-full max-w-lg max-h-full p-4 max-h-auto">
      ...
      <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 rounded-t dark:border-gray-700 md:p-5">
          ...
          <button type="button" className="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg ms-auto hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="accountInformationModal2">
        ...
        <form className="p-4 md:p-5">
          <div className="grid grid-cols-1 gap-4 mb-5 sm:grid-cols-2">
            <div className="col-span-2">
              <label for="pick-up-point-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Pick-up point* </label>
            ...
            <div className="col-span-2 sm:col-span-1">
              <label for="full_name_info_modal" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Your Full Name* </label>
            ...
            <div className="col-span-2 sm:col-span-1">
              <label for="email_info_modal" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Your Email* </label>
            ...
            <div className="col-span-2">
              <label for="phone-input_billing_modal" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Phone Number* </label>
              <div className="flex items-center">
                <button id="dropdown_phone_input__button_billing_modal" data-dropdown-toggle="dropdown_phone_input_billing_modal" className="z-10 inline-flex shrink-0 items-center rounded-s-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700" type="button">
                  <svg fill="none" aria-hidden="true" className="w-4 h-4 me-2" viewBox="0 0 20 15">
                ...
                <div id="dropdown_phone_input_billing_modal" className="z-10 hidden w-56 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
                  <ul className="p-2 text-sm font-medium text-gray-700 dark:text-gray-200" aria-labelledby="dropdown_phone_input__button_billing_modal">
                    <li>
                      <button type="button" className="inline-flex w-full px-3 py-2 text-sm text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
            ...
            <div className="col-span-2">
              <label for="address_billing_modal" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Delivery Address* </label>
            ...
            <div className="col-span-2 sm:col-span-1">
              <label for="vat_number" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> VAT number </label>
