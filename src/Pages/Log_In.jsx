          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form onSubmit={SubmitHandle} className="space-y-4 md:space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a onClick={forgetPassword} className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500 cursor-pointer">Forgot password?</a>
              </div>
              {err && <p className='text-red-500'>{err}</p>}
              <Button className='bg-main-color' >Sign in</Button>
              <Link to={'/sign-up'} className="text-sm block font-light text-gray-500 dark:text-gray-400">
